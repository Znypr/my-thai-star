...
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, orderStatus, paid) VALUES (2, 1, 3, 1, null, 'paid', 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, orderStatus, paid) VALUES (3, 1, 3, 2, null, 'paid', 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, orderStatus, paid) VALUES (4, 1, 3, 3, null, 'cancelled', 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, orderStatus, paid) VALUES (5, 1, 3, 4, null, 'cancelled', 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, orderStatus, paid) VALUES (6, 1, 4, 8, null, 'open', 0);
INSERT INTO Orders (id, modificationCounter, idBooking, idInvitedGuest, idHost, orderStatus, paid) VALUES (7, 1, 4, 9, null, 'open', 0);
