...
public class AlexaTest {
  ...
  public void setUp() throws InterruptedException {
    ...
    System.setProperty("webdriver.chrome.driver",
            "C:\\Users\\Joost\\Desktop\\Projekte\\my-thai-star\\java\\alexa-test\\chromedriver.exe");
  ...
  public void askForCategories() throws InterruptedException {
    ...
    this.driver.findElement(By.cssSelector(".askt-utterance__input")).sendKeys(Keys.ENTER);
    Thread.sleep(5000);
    assertEquals("step7", "Die Anfrage fuehrte zu keinen Ergebnissen. Bitte versuchen Sie eine andere Anfrage.",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(500);
  ...
  public void filterBeverage() throws InterruptedException {
    ...
    // css=.askt-dialog__message--response
    Thread.sleep(5000);
    assertEquals("step4", "Die Anfrage fuehrte zu keinen Ergebnissen. Bitte versuchen Sie eine andere Anfrage.",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(500);
  ...
  public void searchDish() throws InterruptedException {
    ...
    this.driver.findElement(By.cssSelector(".askt-utterance__input")).sendKeys(Keys.ENTER);
    Thread.sleep(5000);
    assertEquals("Es gibt: Thai green chicken curry, Thai Spicy Basil Fried Rice, Garlic Paradise Salad",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(500);
  ...
  public void orderWithoutExtra() throws InterruptedException {
    ...
    assertEquals(
            "Wollen Sie Tofu oder extra Curry, falls fuer das ausgewaehlte Gericht moeglich, zu ihrer Bestellung hinzufuegen?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
    ...
    assertEquals("Sie muessen zunaechst einen Tisch buchen um Bestellungen zu taetigen.",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
    ...
    assertEquals("Wie viele Personen?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
    ...
    assertEquals("Ihr Warenkorb enthaelt 3 thai green chicken curry ohne Extra",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
  }
  ...
  public void orderWithExtra() throws InterruptedException {
    ...
    assertEquals("Es wird 3 thai green chicken curry mit tofu extra zum Warenkorb hinzugefuegt, korrekt?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
    ...
    assertEquals("Ihr Warenkorb enthaelt 3 thai green chicken curry mit extra Tofu",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
  }
  ...
  public void invalidOrder() throws InterruptedException {
    ...
    assertEquals(
            "Das verstehe ich nicht. Wollen Sie Tofu oder extra Curry, falls fuer das ausgewaehlte Gericht moeglich, zu ihrer Bestellung hinzufuegen?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
  ...
  public void bookTableTomorrow() throws InterruptedException {
    ...
    Thread.sleep(5000);
    assertEquals("step1", "Wie viele Personen?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
    ...
    assertEquals("step2", "Welcher Tag?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
    this.driver.findElement(By.cssSelector(".askt-utterance__input")).sendKeys("morgen");
    this.driver.findElement(By.cssSelector(".askt-utterance__input")).sendKeys(Keys.ENTER);
    ...
    assertEquals("step2", "Um wie viel Uhr?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
  ...
  public void printShoppingCartBeforeBooking() throws InterruptedException {
    ...
    assertEquals("Es wird 1 thai peanut beef mit tofu extra zum Warenkorb hinzugefuegt, korrekt?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
    ...
    assertEquals("Es wird 1 thai green chicken curry mit tofu extra zum Warenkorb hinzugefuegt, korrekt?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
  ...
  public void printShoppingCartWithMultipleDishs() throws InterruptedException {
    ...
    assertEquals("Es wird 3 thai green chicken curry zum Warenkorb hinzugefuegt, korrekt?",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
  ...
  public void printDescription() throws InterruptedException {
    ...
    Thread.sleep(5000);
    assertEquals(
            "Beschreibung von Thai green chicken curry : Master this aromatic, creamy and extremely tasty chicken Thai green curry recipe from Jamie Oliver and treat yourself to an authentic taste of South East Asia. Tofu Option verfuegbar.",
            this.driver.findElement(By.cssSelector(".askt-dialog__message--active-response")).getText());
    Thread.sleep(5000);
  }
