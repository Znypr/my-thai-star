...
==== Cancel Reservation
A host cancel the reservation, everybody that has accepted or not already answered will receive an email notifying this event is cancelled. Also all the orders related to this reservations will be removed.
